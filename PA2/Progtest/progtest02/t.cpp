...
// InvalidDateException class implementaion by inherting standard invalid argument error class
// so it is like creating my own exception type and it will behave like a standard argumnet error
...
private:  
    ...
    static int toSerial(int y, int m, int d);
    static CDate fromSerial(int n);
